...
class OsakaPlanner:
    ...
    def plan_trip(self, origin: str, destination: str = "大阪",
        ...
        print(f"🏯 大阪行程规划：{origin} → {destination}")
        ...
        attractions = {
            "文化": [
                {"name": "大阪城", "duration": "2h", "cost": 600},
                {"name": "法善寺", "duration": "1h", "cost": 0},
                {"name": "四天王寺", "duration": "1.5h", "cost": 300},
            ],
            "美食": [
                {"name": "道顿堀", "duration": "3h", "cost": 2000},
                {"name": "新世界", "duration": "2h", "cost": 1500},
            ],
            "购物": [
                {"name": "心斋桥", "duration": "3h", "cost": 0},
                {"name": "美国村", "duration": "2h", "cost": 0},
            ],
            "主题乐园": [
                {"name": "环球影城", "duration": "1d", "cost": 7900},
            ],
        }
...
def main():
    ...
    plan = planner.plan_trip("北京", "大阪", "2026-05-01", "2026-05-07", budget=12000, travelers=2)
    planner.save_plan(plan, "osaka_plan")
