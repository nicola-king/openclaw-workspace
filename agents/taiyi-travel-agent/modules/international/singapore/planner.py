...
class SingaporePlanner:
    ...
    def plan_trip(self, origin: str, destination: str = "新加坡",
        ...
        print(f"🦁 新加坡行程规划：{origin} → {destination}")
        ...
        attractions = {
            "现代都市": [
                {"name": "鱼尾狮公园", "duration": "1h", "cost": 0},
                {"name": "滨海湾金沙", "duration": "2h", "cost": 0},
                {"name": "环球影城", "duration": "1d", "cost": 75},
            ],
            "自然风光": [
                {"name": "滨海湾花园", "duration": "3h", "cost": 30},
                {"name": "圣淘沙岛", "duration": "1d", "cost": 20},
            ],
            "购物": [
                {"name": "乌节路", "duration": "3h", "cost": 0},
                {"name": "小印度", "duration": "2h", "cost": 0},
            ],
        }
...
def main():
    ...
    plan = planner.plan_trip("北京", "新加坡", "2026-05-01", "2026-05-05", budget=15000, travelers=2)
    planner.save_plan(plan, "singapore_plan")
