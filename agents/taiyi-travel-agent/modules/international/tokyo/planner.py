...
class TokyoPlanner:
    ...
    def plan_trip(self, origin: str, destination: str = "东京",
                 start_date: str = "2026-05-01", end_date: str = "2026-05-07",
                 budget: float = 15000, travelers: int = 1,
                 preferences: Optional[List[str]] = None) -> Dict:
        print(f"🗼 东京行程规划：{origin} → {destination}")
        ...
        attractions = {
            "文化": [
                {"name": "浅草寺", "duration": "2h", "cost": 0},
                {"name": "东京塔", "duration": "2h", "cost": 1500},
                {"name": "明治神宫", "duration": "2h", "cost": 0},
            ],
            "购物": [
                {"name": "涩谷十字路口", "duration": "3h", "cost": 0},
                {"name": "秋叶原", "duration": "3h", "cost": 5000},
                {"name": "银座", "duration": "3h", "cost": 0},
            ],
            "美食": [
                {"name": "筑地市场", "duration": "2h", "cost": 3000},
                {"name": "新宿御苑", "duration": "2h", "cost": 500},
            ],
            "主题乐园": [
                {"name": "东京迪士尼", "duration": "1d", "cost": 7400},
            ],
        }
...
def main():
    ...
    plan = planner.plan_trip("北京", "东京", "2026-05-01", "2026-05-07", budget=15000, travelers=2)
    planner.save_plan(plan, "tokyo_plan")
