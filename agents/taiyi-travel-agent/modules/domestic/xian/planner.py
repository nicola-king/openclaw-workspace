...
class XianPlanner:
    ...
    def plan_trip(self, origin: str, destination: str = "西安",
        ...
        print(f"🏯 西安行程规划：{origin} → {destination}")
        ...
        attractions = {
            "历史文化": [
                {"name": "兵马俑", "duration": "1d", "cost": 120},
                {"name": "大雁塔", "duration": "2h", "cost": 50},
                {"name": "古城墙", "duration": "2h", "cost": 54},
            ],
            "美食": [
                {"name": "回民街", "duration": "2h", "cost": 0},
                {"name": "永兴坊", "duration": "2h", "cost": 0},
            ],
            "文化体验": [
                {"name": "华清池", "duration": "3h", "cost": 120},
                {"name": "陕西历史博物馆", "duration": "3h", "cost": 0},
            ],
        }
...
def main():
    ...
    planner = XianPlanner()
    plan = planner.plan_trip("北京", "西安", "2026-05-01", "2026-05-04", budget=3000, travelers=2)
    planner.save_plan(plan, "xian_plan")
