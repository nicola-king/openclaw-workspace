...
class SmartSearchRouter:
    ...
    def integrate_with_smart_router(self):
        """整合到智能路由系统"""
        # 更新智能路由配置
        smart_router_dir = self.workspace / "skills" / "07-system" / "smart-model-router"
            ...
            'integration_points': [
                {
                    ...
                    'path': str(smart_router_dir),
                    'integration': 'search_type_routing'
                },
                {
                    'name': 'geo-model-router',
                    'path': str(self.workspace / "skills" / "07-system" / "geo-model-router"),
                    'integration': 'geo_based_routing'
                },
                {
                    'name': 'quota-router',
                    'path': str(self.workspace / "skills" / "07-system" / "quota-aware-model-router"),
                    'integration': 'quota_aware_routing'
                }
            ]
        }
        
        with open(self.config_dir / "integration_config.json", 'w', encoding='utf-8') as f:
...
def main():
    ...
    # 整合到智能路由系统
    print("\n🔌 整合到智能路由系统...")
    router.integrate_with_smart_router()
    ...
    report_path = Path("/home/nicola/.openclaw/workspace/reports/smart-search-router-integration.md")
