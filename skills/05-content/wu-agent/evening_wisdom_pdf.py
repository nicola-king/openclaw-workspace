...
WU_OUTPUT_DIR = WORKSPACE / "skills/05-content/wu-agent/data/output"
...
def generate_daily_wisdom():
    """生成每日智慧"""
    print(f"🌙 生成悟 Agent 晚间智慧")
    
    today = datetime.now().strftime('%Y-%m-%d')
    
    # 读取 MD 文件
    md_file = WU_OUTPUT_DIR / f"wu-{today}.md"
...
def send_evening_wisdom():
    """发送晚间智慧"""
    print("=" * 60)
    print("🌙 悟 Agent - 晚间智慧推送 v2.0 (PDF 格式)")
    print("=" * 60)
