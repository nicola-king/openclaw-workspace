...
- 磁盘使用: 150G/1.8T (9%) — 健康
- 措施: 无需要额外归档的项目
[2026-05-31 22:00] 日常归档清理
## 2026-05-31 22:00 归档操作
### 已删除
| 文件 | 类型 | 大小 |
|------|------|------|
| `--template` | CLI 产物 | 8.4 KB |
| `-o` | CLI 产物 | 8.7 KB |
| `.DS_Store` | macOS 残留 | ~8 KB |
### 已归档
| 来源 | 迁移至 | 文件数 |
|------|--------|--------|
| `data/token-monitor/` | `data/.archive/token-monitor/202605/` | 10 个文件 (5/26-28 日志) |
| `reports/` | `data/.archive/reports/202605/` | 7 个文件 (旧报告) |
### 活跃数据目录现状
| 目录 | 大小 | 备注 |
|------|------|------|
| `data/` | 2.5 GB | worldmonitor node_modules 占大头 (2.2GB) |
| `reports/` | 627 KB | 保留 p0p1p2 系列 + global-intel 近期报告 |
| `backup/` | 8 KB | |
### 今日新文件 (2026-05-31)
- 冰岛_卡塔尔_买家线索报告 (*.md/*.pdf 双版本)
- Iceland_Qatar_Buyer_Leads_Report (*.md/*.pdf 英文版)
- `TOOLS.md` 更新
- `memory/2026-05-31.md` 日志更新
