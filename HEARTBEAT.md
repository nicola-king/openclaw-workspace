...
### 📿 晨间智慧推送（08:00-09:00 执行）
**触发条件**：当前时间 08:00-09:00 且 `.wisdom-today.md` 存在
**执行动作**：
```bash
# 读取并发送晨间智慧
cat /home/nicola/.openclaw/workspace/.wisdom-today.md
```
**发送后**：删除 `.wisdom-today.md` 或标记为已发送
